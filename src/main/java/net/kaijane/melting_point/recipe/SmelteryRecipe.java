...
public class SmelteryRecipe implements Recipe<SimpleInventory> {
    ...
    public static class Type implements RecipeType<SmelteryRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "smeltery";
    }
    ...
    public static class Serializer implements RecipeSerializer<SmelteryRecipe> {
        ...
        public static final Codec<SmelteryRecipe> CODEC = RecordCodecBuilder.create(in -> in.group(
                validateAmount(Ingredient.DISALLOW_EMPTY_CODEC, 9).fieldOf("ingredients").forGetter(SmelteryRecipe::getIngredients),
