...
public class SmelteryScreenHandler extends ScreenHandler {
    ...
    public SmelteryScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public SmelteryScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(ModScreenHandlers.SMELTERY_SCREEN_HANDLER, syncId);
        checkSize(((Inventory) blockEntity), 2);
        this.inventory = ((Inventory) blockEntity);
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity = ((SmelteryBlockEntity) blockEntity);
